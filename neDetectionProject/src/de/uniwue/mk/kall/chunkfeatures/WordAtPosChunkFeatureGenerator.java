...
public class WordAtPosChunkFeatureGenerator extends AFeatureGenerator {

  private int pos;

  public WordAtPosChunkFeatureGenerator(int pos) {
  ...
  public String[] generateFeature(TokenInstance instance, CAS cas, Util_impl util) {
    ...
    String feature = "WordAtPosition_" + pos + "=";
    ...
    return new String[] { (feature + annoAtPos.getCoveredText())
